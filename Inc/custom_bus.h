...
#define BUS_I2C1_SCL_GPIO_PIN LL_GPIO_PIN_6
#define BUS_I2C1_SCL_GPIO_AF GPIO_AF1_I2C1
#define BUS_I2C1_SCL_GPIO_CLK_ENABLE() LL_IOP_GRP1_EnableClock(LL_IOP_GRP1_PERIPH_GPIOB)
#define BUS_I2C1_SCL_GPIO_PORT GPIOB
#define BUS_I2C1_SCL_GPIO_CLK_DISABLE() LL_IOP_GRP1_DisableClock(LL_IOP_GRP1_PERIPH_GPIOB)
#define BUS_I2C1_SDA_GPIO_PIN LL_GPIO_PIN_7
#define BUS_I2C1_SDA_GPIO_AF GPIO_AF1_I2C1
#define BUS_I2C1_SDA_GPIO_CLK_ENABLE() LL_IOP_GRP1_EnableClock(LL_IOP_GRP1_PERIPH_GPIOB)
#define BUS_I2C1_SDA_GPIO_PORT GPIOB
#define BUS_I2C1_SDA_GPIO_CLK_DISABLE() LL_IOP_GRP1_DisableClock(LL_IOP_GRP1_PERIPH_GPIOB)
